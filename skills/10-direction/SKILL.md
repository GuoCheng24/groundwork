...
- [`lit-review.md`](lit-review.md) — reading so the survey produces a direction rather than a reading list
- [`kill-argument.md`](kill-argument.md) — steelman it, then try to end it today
