...
paper, submission, memory — with the stage most toolkits are missing: **one
that returns NO-GO.**
...
> to produce cheaply and the one walkthroughs rarely show you.
>
> From installing Claude Code or Codex to running a whole project with one —
> including the case most tutorials skip: **a shared cluster node with no
...
| [`40-write`](https://github.com/GuoCheng24/groundwork/tree/main/groundwork/skills/40-write) | Write — from claims, not from results | [`build`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/40-write/build.md) · [`captions`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/40-write/captions.md) · [`claims`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/40-write/claims.md) · [`diagrams`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/40-write/diagrams.md) · [`docx-from-latex`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/40-write/docx-from-latex.md) · [`figures`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/40-write/figures.md) · [`latex`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/40-write/latex.md) · [`revision`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/40-write/revision.md) · [`slides`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/40-write/slides.md) · [`structure`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/40-write/structure.md) · [`theory`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/40-write/theory.md) |
| [`50-submit`](https://github.com/GuoCheng24/groundwork/tree/main/groundwork/skills/50-submit) | Submit — and everything after | [`compliance`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/50-submit/compliance.md) · [`delivery`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/50-submit/delivery.md) · [`grants`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/50-submit/grants.md) · [`patent`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/50-submit/patent.md) · [`patent-disclosure`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/50-submit/patent-disclosure.md) · [`portals`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/50-submit/portals.md) · [`rebuttal`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/50-submit/rebuttal.md) · [`resubmit`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/50-submit/resubmit.md) · [`talks`](https://github.com/GuoCheng24/groundwork/blob/main/groundwork/skills/50-submit/talks.md) |
